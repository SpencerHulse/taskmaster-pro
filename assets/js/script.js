...
$(".list-group").on("blur", "textarea", function () {
  ...
  //save the new values for the object
...
//makes list items draggable between lists
...
}, 1000 * 60 * 30); //1000 miliseconds * 60 seconds to get 1 minute, then times 30 for 30 minutes
